...
class BaseClientTest extends TestCase
{
    ...
    public function testHttpClient()
    {
        ...
        // custom client
        $http = new Client(['base_uri' => 'http://Enjelly.com']);
        $app = new ServiceContainer([], [
            'http_client' => $http,
        ]);
    ...
    public function testAccessTokenMiddleware()
    {
        ...
        $request = new Request('GET', 'http://Enjelly.com');
        $options = ['foo' => 'bar'];
    ...
    public function testRetryMiddleware()
    {
        ...
        $app = new ServiceContainer([]);
        $app['logger'] = $logger = \Mockery::mock(Logger::class, ['Enjelly']);
        ...
        $p = $c->sendAsync(new Request('GET', 'http://Enjelly.com'), []);
        $response = $p->wait();
