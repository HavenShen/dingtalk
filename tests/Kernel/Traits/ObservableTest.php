...
use Closure;
use Enjelly\Kernel\Contracts\EventHandlerInterface;
use Enjelly\Kernel\Decorators\FinallyResult;
use Enjelly\Kernel\Decorators\TerminateResult;
use Enjelly\Kernel\Exceptions\Exception;
...
class ObservableTest extends TestCase
{
    ...
    public function testMakeClosureWithInvalidCases()
    {
        ...
        try {
            ...
            $this->assertSame('Class "stdClass" not an instance of "Enjelly\Kernel\Contracts\EventHandlerInterface".', $e->getMessage());
        }
