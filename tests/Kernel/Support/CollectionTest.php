...
class CollectionTest extends TestCase
{
    ...
    {
        $data = new Collection(['first' => 'overtrue', 'last' => 'Otwell', 'email' => 'overtrue@Enjelly.com']);
        $this->assertSame(['first' => 'overtrue'], $data->only(['first', 'missing'])->all());
        $this->assertSame(['first' => 'overtrue', 'email' => 'overtrue@Enjelly.com'], $data->only(['first', 'email'])->all());
    }
    ...
    public function testExcept()
    {
        ...
        $this->assertSame(['first' => 'overtrue'], $data->except('last', 'email', 'missing')->all());
        $this->assertSame(['first' => 'overtrue', 'email' => 'overtrue@Enjelly.com'], $data->except(['last'])->all());
        $this->assertSame(['first' => 'overtrue', 'email' => 'overtrue@Enjelly.com'], $data->except('last')->all());
    }
