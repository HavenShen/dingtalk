...
use Enjelly\Kernel\Support\Arr;
...
class ArrTest extends TestCase
{
    ...
    {
        $array = Arr::add(['name' => 'Enjelly'], 'price', 100);
        $this->assertSame(['name' => 'Enjelly', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'Enjelly']);
        $this->assertSame(['name'], $keys);
        $this->assertSame(['Enjelly'], $values);
    }
    ...
    {
        $array = ['name' => 'Enjelly', 'price' => 100];
        $array = Arr::except($array, ['price']);
        $this->assertSame(['name' => 'Enjelly'], $array);
    }
    ...
    {
        $array = ['name' => 'Enjelly', 'price' => 100, 'orders' => 10];
    ...
    public function testForget()
    {
        ...
        // Only works on first level keys
        $array = ['i@example.com' => 'Joe', 'i@Enjelly.com' => 'Jane'];
        Arr::forget($array, 'i@example.com');
        $this->assertSame(['i@Enjelly.com' => 'Jane'], $array);
        // Does not work for nested keys
