...
use Enjelly\Kernel\EncryptorWechat;
use Enjelly\Kernel\Exceptions\RuntimeException;
use Enjelly\Kernel\Support\XML;
use Enjelly\Tests\TestCase;

class EncryptorWechatTest extends TestCase
{
    public function getEncryptor()
    {
        return new EncryptorWechat('wxb11529c136998cb6', 'pamtest', 'abcdefghijklmnopqrstuvwxyz0123456789ABCDEFG');
    }
    ...
    public function testDecryptWithErrorAppId()
    {
        ...
        $encrypted = "<xml>\n    <ToUserName><![CDATA[asdasdasd]]></ToUserName>\n    <Encrypt><![CDATA[]]></Encrypt>\n</xml>\n";
        $encryptor = new EncryptorWechat('invalid appid', 'pamtest', 'abcdefghijklmnopqrstuvwxyz0123456789ABCDEFG');
        $encrypt = XML::parse($encrypted);
