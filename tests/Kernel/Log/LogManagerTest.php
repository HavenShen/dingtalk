...
namespace Enjelly\Tests\Kernel\Log;

use Enjelly\Kernel\Config;
use Enjelly\Kernel\Log\LogManager;
...
class LogManagerTest extends TestCase
{
    ...
    public function testDriverCreators()
    {
        ...
        $this->assertInstanceOf(Logger::class, $log->createSlackDriver(['url' => 'https://Enjelly.com']));
