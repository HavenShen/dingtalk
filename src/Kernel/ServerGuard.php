...
class ServerGuard
{
     ...
     * @return $this
     *
     * @throws \Enjelly\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\Enjelly\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \Enjelly\Kernel\Exceptions\InvalidArgumentException
     * @throws \Enjelly\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \Enjelly\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \Enjelly\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \Enjelly\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
